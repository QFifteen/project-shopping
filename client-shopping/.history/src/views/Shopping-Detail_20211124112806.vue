              ...
              <Col span="12">
                <div class="shopping-text">
                  ...
                  <div class="chicun">
                    <p>尺寸:</p>
                    <div class="xuan-zhe">
                      <RadioGroup v-model="border" type="button" @change="but(e)">
                        <Radio label="M" border class="but"></Radio>
                        <Radio label="L" border class="but"></Radio>
                        <Radio label="XL" border class="but"></Radio>
                        <Radio label="XXL" border class="but"></Radio>
                      </RadioGroup>
                    </div>
                  </div>
                </div>
