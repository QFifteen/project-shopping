          ...
          <article>
            <Row>
              ...
              <div class="shopping-text">
                ...
                <p class="shopping-Introduction">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                <!-- 价格-折扣 -->
                <div class="shopping-price">
                    <p><span class="price-title">秒杀价:</span><span class="iconfont-shopping shop-jiage price"></span><span class="price">324.1</span></p>
                    <p><span class="price-title">折扣:</span><span class="iconfont-shopping shop-jiage price"></span><span class="price">324.1</span></p>
                </div>
              </div>
              </Col>
            </Row>
