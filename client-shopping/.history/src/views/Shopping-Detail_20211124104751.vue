            ...
            <Row>
              ...
              <div class="shopping-text">
                ...
                <div class="shopping-price">
                    <ul>
                        <li><span class="price-title">秒杀价:</span><span class="iconfont-shopping shop-jiage price">100.1</span></li>
                        <li><span>折扣:</span><span class="iconfont-shopping shop-zhekou price">8.5</span></li>
                    </ul>
                </div>
                <div class="chicun">
                    <p>尺寸:</p>
                    <div class="xuan-zhe"></div>
                </div>
              </div>
              </Col>
            </Row>
