...
————————————————
版权声明：本文为CSDN博主「Code进阶狼人」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/liuzuoping/article/details/103718256
        </Col>
        <Col span="1"></Col>
      </Row>
    </article>
...
<script src="../assets/js/Shopping-Detail.js" type="text/JavaScript"></script>
<script>
