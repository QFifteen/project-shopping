          ...
          <div>
            <Row type="flex" justify="center">
              ...
              <div class="bottomtext1">
                <p>第一眼，看见你的与众不同</p>
                <p class="bottomzhengwen">个性化推荐，用态度决定一切。从时尚出发，艺术从来不用拘束于人。</p>
                <p class="bottomzhengwen"></p>
                <p class="bottomzhengwen">服饰艺术在哪里？在大胆不被人审美所看好的地方</p>
                </div>
                </Col>
              <Col span="12">
              <img v-lazy="require('../assets/images/fy18b.jpg')" alt="" width="100%">
              </Col>
              </Row>
          </div>
        </section>
