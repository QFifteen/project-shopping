        ...
        <Col span="20">
          <section class="bottomall">
            ...
            <div class="illustration">
                <Row type="flex" justify="center" alig">
                  <Col span="6"> 
                    <img v-lazy="require('../assets/images/illustration1.png')" alt="" width="30%">
                  </Col>
                  <Col span="6"><img v-lazy="require('../assets/images/illustration3.png')" alt="" width="30%"></Col>
                  <Col span="6"><img v-lazy="require('../assets/images/illustration2.png')" alt="" width="30%"></Col>
                  <Col span="6"><img v-lazy="require('../assets/images/illustration4.png')" alt="" width="30%"></Col>
                </Row>
            </div>
          </section>
        </Col>
