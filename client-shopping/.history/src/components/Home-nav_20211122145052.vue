<template>
  <div>
    ...
    <section>
        ...
        <CarouselItem v-for="item in imglist" :key="">
...
export default {
  ...
  data() {
    return {
      value2: 0,
      imglist:['../assets/images/banner/banner1.png','../assets/images/banner/banner2.png','../assets/images/banner/banner3.png','../assets/images/banner/banner4.png']
    };
  },
  methods: {},
};
