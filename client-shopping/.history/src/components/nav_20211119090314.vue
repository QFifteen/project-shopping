        ...
        <Col span="14"
          ><div class="Covertext">
            ...
            <div class="bottomtext">
              <Row type="flex" style="height:100%" align="middle" justify="space-around">
                <Col span="12"><span>伍蒙服饰电商</span></Col>
              <Col span="12" style="background:red"><span>成为会员，体验时尚</span></Col>
              </Row>
            </div>
          </div></Col
        >
