<template>
  <div class="login">
    ...
    <Modal v-model="modal1" width="360" >
       <div style="text-align:center">//对话框主体
            <p>After this task is deleted, the downstream 10 tasks will not be implemented.</p>
            <p>Will you delete it?</p>
        </div>
————————————————
版权声明：本文为CSDN博主「小李ing」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/qq_37496470/article/details/106093520
        <div slot="footer">
