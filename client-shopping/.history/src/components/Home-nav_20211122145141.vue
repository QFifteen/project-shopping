...
export default {
  ...
  data() {
    return {
      value2: 0,
      imglist:[
          {id:1,imgurl:'../assets/images/banner/banner1.png'},{id:1,imgurl:'../assets/images/banner/banner1.png'},{id:1,imgurl:'../assets/images/banner/banner1.png'},{id:1,imgurl:'../assets/images/banner/banner1.png'}
          ]
    };
  },
  methods: {},
