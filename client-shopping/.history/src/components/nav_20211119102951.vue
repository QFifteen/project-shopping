          ...
          <section class="bottomall">
            ...
            <div>
                <Row>
                  ...
                  <Col span="6"><img v-lazy="require('../assets/images/illustration3.png')" alt="" width="35%"></Col>
                  <Col span="6"><img v-lazy="require('../assets/images/illustration2.png')" alt="" width="35%"></Col>
                  <Col span="6"><img v-lazy="require('../assets/images/illustration4.png')" alt="" width="35%"></Col>
                </Row>
            </div>
          </section>
        </Col>
