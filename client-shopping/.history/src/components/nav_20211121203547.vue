  ...
  <div class="login">
    ...
    <Modal v-model="modal1" width="800">
       <div style="text-align:center">
        <Row>
          <Col span="8"><img v-lazy="require('../assets/images/login/loginimg.png')" alt="" width="100%"></Col>
          <Col span="15" push="1">
              <Tabs value="name1">
        <Tab-pane label="标签一" name="name1">
          
          <div class="modal-login">
              <span class="model-logintext">登录账号</span>
              
                  <Form ref="formCustom" :model="formCustom" :rules="ruleCustom" :label-width="50">
