                      ...
                      <Tabs :value="name">
                          ...
                          <div class="modal-login">
                            ...
                            >
                              <FormItem label="账号：" prop="passwd">
                                ...
                                ><Icon class="iconfont-shopping shop-zhanghaodenglu" slot="prefix" /></Input>
                              </FormItem>
                        ...
                        <Tab-pane label="注册账号" name="name2">
                          <Form
                            ...
                            :label-width="75"
                          >
                            <p class="model-logintext"><span class="iconfont-shopping shop-zhucetianjiahaoyou"></span>注册账号</p>
                            ...
                            <FormItem label="邮箱:" prop="mail">
                              ...
                              >            <Icon class="iconfont-shopping shop-youxiang" slot="prefix" /></Input>
                            </FormItem>
                            <FormItem label="密码:" prop="pass">
                              <Input
                                v-model="formValidate.pass"
                                placeholder="Enter your e-mail"
                              ><Icon class="iconfont-shopping shop-mima" slot="prefix" /></Input>
                            </FormItem>
